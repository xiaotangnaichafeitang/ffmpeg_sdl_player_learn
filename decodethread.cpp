...
//    if (codec_ctx_ == nullptr || par == nullptr) {
//        std::cout << "Invalid codec context or codec parameters" << std::endl;
//        return -1; // Or handle error accordingly
//    }

//    if (codec_ctx_ == nullptr || codec_ctx_->codec == nullptr) {
//        if(codec_ctx_ == nullptr){
//            std::cout << "codec_ctx_ == nullptr" << std::endl;
//        }
//        if(codec_ctx_->codec == nullptr){
//            std::cout << "codec_ctx_->codec == nullptr" << std::endl;
//        }
//        std::cerr << "Codec context is not properly initialized" << std::endl;
//        return -1;
//    }
